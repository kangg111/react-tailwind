...
const Navbar = () => {
  ...
  return (
    <div className="w-full fixed top-0 left-0 right-0 z-10 flex justify-between items-center h-24 mx-auto px-4 text-white bg-[#5e3b3f]">
      <h1 className="w-full text-3xl font-bold text-[#95c4b8]">WEB.</h1>
